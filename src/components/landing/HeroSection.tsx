    ...
    <section id="hero" className="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        <div className="mb-6 inline-block rounded-full border border-[var(--brand-gold)]/30 bg-[var(--brand-gold)]/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[var(--brand-gold)]">
          Apostolic Gathering &middot; Uhuru Park, Nairobi &middot; Aug 31 &ndash; Sep 4, 2026
        </div>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-white/70 sm:text-xl">
          An opportune window to apprehend the intangible: graces, mantles, and
          above all, God Himself. Join the global movement dedicated to sharing
          the unadulterated and authentic word of God to all generations.
        </p>

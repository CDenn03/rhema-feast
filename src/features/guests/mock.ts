...
export const MOCK_GUEST_INVITES: GuestInvite[] = [
  {
    ...
    email: "julian.kyula@ruachassembly.org",
    phone: "+254 712 345 678",
    organization: "Ruach Assembly",
  ...
  },
  {
    ...
    email: "joshua.selman@koinonia.org",
    phone: "+234 803 123 4567",
    organization: "Koinonia Global",
    defaultPlusOneCount: 2,
    maxPlusOnes: 2,
    zoneId: "zone_vip",
    seatId: "seat_v004",
  ...
  },
  {
    ...
    email: "nathaniel.bassey@example.com",
    phone: "+234 803 789 0123",
    organization: "The Great Commission Church",
    defaultPlusOneCount: 2,
    maxPlusOnes: 1,
    zoneId: "zone_vip",
    seatId: "seat_b001",
  ...
  },
  {
    ...
    email: "jb.masinde@example.com",
    phone: "+254 745 678 901",
    organization: "Faith Cathedral",
    defaultPlusOneCount: 2,
    maxPlusOnes: 2,
    zoneId: "zone_vip",
    seatId: null,
  ...
  },
  {
    ...
    email: "william.kimani@example.com",
    phone: "+254 756 789 012",
    organization: "Grace International Church",
    defaultPlusOneCount: 2,
    maxPlusOnes: 2,
    zoneId: "zone_vip",
    seatId: null,
    status: "confirmed",
    inviteSentAt: "2026-07-20T08:00:00Z",
